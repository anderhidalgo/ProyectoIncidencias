...
class formModificarTecnico {
    
    
    public static function modificacionTecnico($id){

        $tecnicos = $_SESSION["tecnicos"];
        $nombreT = Controlador::buscarNombreTecnicoPorID($id);
        $_SESSION["IdTecnicoPorIdIncidencia"] = $id;
  ...
  <!-- Custom styles for this template-->
        <link href="/ProyectoIncidencias/Vista/estilos/css/sb-admin.css" rel="stylesheet">
            ...
            <title>Modificacion tecnico</title>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">ModificarTecnico</li>
      </ol>

      <h1>Modificacion del Técnico Asignado</h1>
      <hr>
      
      <form action="/ProyectoIncidencias/Controlador/router.php" method="post">

             <p>El técnico asignado actual en la incidencia <b><?php echo $id ?></b> es <b><?php echo $nombreT?></b>.</p>
             <p>A continuación, selecciona en la lista desplegable al técnico que le quieres pasar la incidencia:
             ...
             <select name="tecnico">
                    ...
                    for($x=0;$x<count($tecnicos);$x++) {
                        ?><option name ="tecnico" value = "<?php echo $tecnicos[$x]->getId_tecnico();?>"><?php echo $tecnicos[$x]->getNombre();?></option><?php                      
                    }
                        ?>
            ...
            <input class="btn btn-success" type="submit" name="modificarTecnico" value="Modificar">
            <input class="btn btn-danger" type="submit" name="volverAlListado" value="Volver">
